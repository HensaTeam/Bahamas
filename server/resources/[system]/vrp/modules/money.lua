...
function vRP.addBank(user_id,amount)
	if parseInt(amount) > 0 then
		...
		vRP.query("characters/addBank",{ id = parseInt(user_id), bank = amount })
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- DELBANK
...
function vRP.delBank(user_id,amount)
	if parseInt(amount) > 0 then
		local amount = parseInt(amount)
		vRP.query("characters/removeBank",{ id = parseInt(user_id), bank = amount })
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- GETBANK
...
function vRP.addFines(user_id,amount)
	if parseInt(amount) > 0 then
		local amount = parseInt(amount)
		vRP.query("characters/addFines",{ id = parseInt(user_id), fines = amount })
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- DELFINES
...
function vRP.delFines(user_id,amount)
	if parseInt(amount) > 0 then
		local amount = parseInt(amount)
		vRP.query("characters/removeFines",{ id = parseInt(user_id), fines = amount })
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- PAYMENTGEMS
	...
	if parseInt(amount) > 0 then
		...
		if infoAccount then
			if infoAccount["gems"] >= amount then
				vRP.query("accounts/removeGems",{ license = identity["license"], gems = amount })
				return true
			end
		end
	end
